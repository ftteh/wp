...
<span style="font-size:30px;cursor:pointer;" onclick="openNav()">&#9776;Menu</span>
	...
	<h1>Update Application</h1>
		...
		?>
		<form action="lupdate.php" onsubmit=" return formValidator()" method="post">
...
EOT;
				...
				while($row2 = mysql_fetch_array($result2))
					...
					if($bookingslot["t1"]=="booked" && $bookingInfo['t1']=="free")
						...
						echo '<td align="center"><p>You Booked Previously</p><input value="ubooked" checked  name="t1" type="checkbox"></td>';
					}	
					else	
					...
					if($bookingslot["t2"]=="booked"  && $bookingInfo['t2']=="free")
						echo '<td align="center"><p>Booked</p><input value="booked" checked style="visibility:hidden" name="t2" type="checkbox"></td>';
							...
							echo '<td align="center"><p>You Booked Previously</p><input value="ubooked" checked  name="t2" type="checkbox"></td>';
					}
					else	
					...
					if($bookingslot["t3"]=="booked"  && $bookingInfo['t3']=="free")
						...
						echo '<td align="center"><p>You Booked Previously</p><input value="ubooked" checked  name="t3" type="checkbox"></td>';
					}	
					else	
					...
					if($bookingslot["t4"]=="booked"  && $bookingInfo['t4']=="free")
						...
						echo '<td align="center"><p>You Booked Previously</p><input value="ubooked" checked  name="t4" type="checkbox"></td>';
					}
					else	
					...
					if($bookingslot["t5"]=="booked" && $bookingInfo['t5']=="free")
						echo '<td align="center"><p>Booked</p><input value="booked" checked style="visibility:hidden" name="t5" type="checkbox"></td>';
							...
							echo '<td align="center"><p>You Booked Previously</p><input value="ubooked" checked  name="t5" type="checkbox"></td>';
					}
					else	
...
EOT;
		...
		<input id="box"  hidden style="visibility:hidden"  type="date" name="bookedDate" value="<?php echo $bookingInfo["bookedDate"]?>" >
		<input id="box" hidden style="visibility:hidden" type="text"  name="roomId" value="<?php echo $bookingInfo["roomId"]?>" >
	</form>
	</table>
	<script>
